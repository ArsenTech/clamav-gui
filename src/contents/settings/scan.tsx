...
export default function ScanSettings(){
     ...
     return (
          <div className="px-1 py-2 space-y-3">
               <Card>
                    <CardHeader>
                         <CardTitle className="flex items-center gap-2"><Search className="size-5"/> Scan Settings</CardTitle>
                    </CardHeader>
                    <CardContent>
                    ...
                    <Card key={key}>
                         <CardHeader>
                              <CardTitle className="flex items-center gap-2">
                                   {SCAN_OPTION_TITLE[key as ScanOptionGroup].icon}
                                   {SCAN_OPTION_TITLE[key as ScanOptionGroup].title}
                              </CardTitle>
                         </CardHeader>
